                        ...
                        <div className="p-4 md:w-1/2 lg:w-1/3">
                            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                ...
                                <div className="p-6">
                                    ...
                                    <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Lung Cancer Diagnosis</h1>
                                    <p className="leading-relaxed mb-3">The lung cancer diagnosis tool assists medical professionals in accurately identifying and evaluating various thoracic region disorders using patient data and medical imaging.</p>
                                    <div className="flex items-center flex-wrap ">
                                        <Link to="https://lungcancerpre.streamlit.app/" target="_blank" className="text-[#3A8799] inline-flex items-center md:mb-2 lg:mb-0 hover:bg-opacity-[0.1] hover:text-black rounded-lg group hover:scale-110 duration-300 ">Diagnose Now
                        ...
                        <div className="p-4 md:w-1/2 lg:w-1/3">
                            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex items-center flex-wrap ">
                                        <Link to="https://streamlit-liverpred-4.onrender.com/" className="text-[#3A8799] inline-flex items-center md:mb-2 lg:mb-0 hover:bg-opacity-[0.1] hover:text-black rounded-lg group hover:scale-110 duration-300 ">Diagnose Now
                                            <svg className="w-4 h-4 ml-2 group-hover:translate-x-3 duration-300 " viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" >
                                                <path d="M5 12h14"></path>
                                                <path d="M12 5l7 7-7 7"></path>
                                            </svg>
                        ...
                        <div className="p-4 md:w-1/2 lg:w-1/3">
                            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex items-center flex-wrap ">
                                        <Link to="https://chronickidneydiseas.streamlit.app/" className="text-[#3A8799] inline-flex items-center md:mb-2 lg:mb-0 hover:bg-opacity-[0.1] hover:text-black rounded-lg group hover:scale-110 duration-300 ">Diagnose Now
                                            <svg className="w-4 h-4 ml-2 group-hover:translate-x-3 duration-300 " viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" >
                                                <path d="M5 12h14"></path>
                                                <path d="M12 5l7 7-7 7"></path>
                                            </svg>
                        ...
                        <div className="p-4 md:w-1/2 lg:w-1/3">
                            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex items-center flex-wrap ">
                                        <Link to="https://heart-disease-prediction-appfkhgletar.streamlit.app/" target="_blank" className="text-[#3A8799] inline-flex items-center md:mb-2 lg:mb-0 hover:bg-opacity-[0.1] hover:text-black rounded-lg group hover:scale-110 duration-300 ">Diagnose Now
                                            <svg className="w-4 h-4 ml-2 group-hover:translate-x-3 duration-300 " viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" >
                                                <path d="M5 12h14"></path>
                                                <path d="M12 5l7 7-7 7"></path>
                                            </svg>
